...
public class IdGenrateUtils {
    ...
    private static IdGenrateUtils idKeyUtil;

    static {
        idKeyUtil = new IdGenrateUtils(getWorkId(),getDataCenterId());
    }
     ...
     */
    public IdGenrateUtils(long workerId, long dataCenterId) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(JSON.toJSONString(chatMsg));
    }
